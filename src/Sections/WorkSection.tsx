...
const Container = styled.div`
    ${tw`flex flex-col items-center gap-14 pt-6 justify-end pb-36 self-center w-[93%] h-[38%] bg-section-works-tericary opacity-100 rounded-[10px] z-10 [box-shadow: -100px 100px 50px black, 100px 100px 50px black]`}
